...
namespace HoloToolkit.Unity
{
	...
	public class SceneSettingsWindow : AutoConfigureWindow<SceneSettingsWindow.SceneSetting>
	{
		...
		protected override void LoadStrings()
		{
			...
			Descriptions[SceneSetting.CameraToOrigin] = "Moves the main camera to the origin of the scene (0,0,0).\n\nWhen a Mixed Reality application starts, the users head is the center of the world. Not having the main camera at 0,0,0 will result in holograms not appearing where they are expected. This option should remain checked unless you have code that explicitly deals with any offset.";
